            ...
            <div class="untree_co-section">
                <div class="container"> 
                    ...
                    <c:set var="id1" value="${account}" />
                        ...
                        <h2 class="h3 mb-3 text-black">Mã giảm giá (Đã áp dụng freeship / Nếu chọn voucher khác sẽ mất freeship)</h2> 
                        <div class="p-5 p-lg-5 border bg-white">

                            <label for="c_code" class="text-black mb-3">Chọn mã :</label>
