    ...
    <body>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sel1" name="vaiTro"  value="${acID.getRole()}">
                                                <option name="vaiTro" value="3">Manager</option>
                                                <option  name="vaiTro" value="1">Staff</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                var passwordInput = document.getElementById("matKhauInput");
                var originalPassword = "${acID.getPassword()}"; // Lấy mật khẩu gốc từ nguồn dữ liệu của bạn
