                                                            ...
                                                            <div class="modal-body">                                
                                                                <form action="MainController">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" type="number" name="subtotal" value="${booking.getSubtotal()}">VND
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Tổng giá</label>
                                                                        <input class="form-control" type="number" name="total" id="total" value="${booking.getTotal()}"> VND
                                                                    </div>
