                ...
                <div class="col-lg-8 col-md-10">
                    <div class="forgot">
                        ...
                        <ol class="list-unstyled">
                            ...
                            <li><span class="text-primary text-medium">3. </span>3. Nhập OTP ở trang tiếp theo</li>
                        </ol>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="email-for-pass">nhập địa chỉ email của bạn</label> <input
                                    ...
                                    class="form-text text-muted">Nhập địa chỉ email đã đăng ký. Sau đó tối
                                    gửi email OTP đến địa chỉ này.</small>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button class="btn btn-success" type="submit">Mật khẩu mới</button>
                            <button href="homepage.jsp" class="btn btn-danger" type="submit">Quay lại trang chủ
                                </button>
                        </div>
                    </form>
                </div>
