            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            <li> <a href="home.jsp"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
...
<!--             avatar-->
            <div id="myModal" class="modal-body">
                <div class="row form-row">
                    ...
                    <!-- Hiển thị hình ảnh đại diện hiện tại -->
                    <img id="avatar" src="current_avatar.jpg" alt="Current Avatar">

                    <!-- Form để tải lên hình ảnh mới -->
