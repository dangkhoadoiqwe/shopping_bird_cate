 ...
 * @author Quang
 */
@WebServlet(name = "BanStaffController", urlPatterns = {"/BanStaffController"})
public class BanStaffController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int status = Integer.parseInt(request.getParameter("accStatus"));
            ...
            if (status == 1) {
                ...
                if (check) {
                    url = "MainController?action=SEARCHS&txtSearch=" + lastSearchValue + "&searchBy=" + searchByValue;
