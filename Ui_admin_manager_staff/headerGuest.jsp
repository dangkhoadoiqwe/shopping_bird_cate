                ...
                <div class="collapse navbar-collapse" id="navbarsFurni">
                    ...
                    <ul>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" id ="dropdown" aria-labelledby="settingDropdown">
                ...
                <div id="cd-login"> 
                    ...
                    <form class="cd-form" action="MainController" method="post">
                        <p class="fieldset">
                            ...
                            <input class="full-width has-padding has-border" type="text" name="username" placeholder="E-mail">
