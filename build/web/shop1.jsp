                        ...
                        <div class="col-lg-7">
                            <div class="search-content">
                                <form action="searchcontrollner" method="get">
                                    ...
                                    <input type="number" style="border-radius: 15px;" name="minPrice"  id="minPrice" min="0" max="1000" step="100" value="0">
                                    <label style="color: white ;border-radius: 15px;" for="maxPrice">Max Price:</label>
                                    <input type="number" style="border-radius: 15px;" name="maxPrice" id="maxPrice" min="0" max="1000" step="100" value="1000">
                        ...
                        <c:forEach var="product" items="${listP}">
                            <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                                <a class="product-item" href="MainControllner?action=ProDetail&proid=${product.getId()}">
                                    <img src="${product.getImg()}" class="img-fluid product-thumbnail" style="border-radius: 15px;">
