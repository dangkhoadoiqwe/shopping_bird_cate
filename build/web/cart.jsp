                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="product-thumbnail">
                                                <img src="${cart.getProduct().getImg()}" alt="Image" class="img-fluid">
                                            </td>
                                            <td class="product-name">
                                                <h2 class="h5 text-black"><a href="MainControllner?action=ProDetail&proid=${cart.getProduct().getId()}">${cart.getProduct().getName()}</a> </h2>
                                            </td>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <c:choose>
                                                <c:when test="${sessionScope.account.role == 1}">
                                                    <button class="btn btn-black btn-lg py-3 btn-block" type="button" onclick="window.location.href = 'checkout.jsp'">Check Out</button>
                                                </c:when>
                                                <c:otherwise>
                                                    <button class="btn btn-black btn-lg py-3 btn-block" type="button" onclick="window.location.href = 'Login.jsp'">Login</button>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
