                        ...
                        <div class="p-3 p-lg-5 border bg-white">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="c_lname" name="c_lname" value="${id1.getFirstName()}">
                                </div>
                            </div>
                                    ...
                                    <form action="${pageContext.request.contextPath}/CheckOut"  method="POST">
                                        <div id="popup" class="popup">
                                            <div class="popup-content">
                                                ...
                                                <input class="form-control" type="text" name="Name" required="" placeholder="${id1.getFirstName()}" maxlength="50" ><br>
                                                <label for="c_lname" class="text-black">Address <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" name="Address" required placeholder="${id1.getAddress()}"  maxlength="50" ><br>
                                                <label for="c_lname" class="text-black">Phone <span class="text-danger">*</span></label>
                                                <input class="form-control" type="text" required name="Phone" placeholder="${id1.getPhone()}"  maxlength="10" ><br>
