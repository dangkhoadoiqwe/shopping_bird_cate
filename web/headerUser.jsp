...
<html>
    ...
    <body>
        <nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
            ...
            <div class="container">
                <a class="navbar-brand" href="MainController?action=LOAD_HOME_PAGE">Furni<span>.</span></a>
                    ...
                    <ul><!-- Thêm menu "Setting" -->
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="settingDropdown">
                                ...
                                <li><a class="dropdown-item" href="MainController?action=delivery&payid=${sessionScope.account.getId()}">Vận chuyển Đơn hàng</a></li>
                                <li><a class="dropdown-item" href="MainController?action=deliveryBoking&payid=${sessionScope.account.getId()}">Vận chuyển Đơn  đã đặt</a></li>
<!--                                <li><a class="dropdown-item" href="MainController?action=hispay&payid=${sessionScope.account.getId()}">Lịch sử thanh toán</a></li>-->
                    ...
                    <ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
                        ...
                        <li><a class="nav-link" href="MainController?action=MY_CART&accId=${account.getId()}"><img src="images/cart.svg"></a></li>
                        <li style="width: 25px; height: 25px; background-color: red; border-radius: 50%; text-align: center; color: white; margin-top: 10px;">
                            <!--<p id="cartSize">${cartSize}</p>-->
                        </li>    
                    </ul>
