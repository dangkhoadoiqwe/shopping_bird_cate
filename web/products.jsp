                                            ...
                                            <div class="row form-row">
                                                ...
                                                <div class="col-12-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input required="" type="number" class="qty-text form-control" id="qty" step="1" min="1" max="1000" name="quantity" value="1">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label>Giá(VND) </label>
                                                        <input type="text" class="form-control" placeholder="590.000" name="price" required=""> </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="modal-body text-center">  
                                                                            ...
                                                                            <form action="UpdateProductServlet" method="post">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="hidden" name="image"     class="form-control-file"  value="${product.getImage()}">
