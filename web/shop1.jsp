...
<!--                    <div class="col-lg-7">
                        <div class="search-content">
                            <form action="searchcontrollner" method="get" onsubmit="return validateForm()">
                                ...
                                <input type="number" style="border-radius: 15px;" name="minPrice"  id="minPrice" min="0" max="100000" step="100" value="0" oninput="checkMinMax()">
                                <label style="color: white ;border-radius: 15px;" for="maxPrice">Max Price:</label>
                                <input type="number" style="border-radius: 15px;" name="maxPrice" id="maxPrice" min="0"   step="100" value="1000" oninput="checkMinMax()">
