                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="${sessionScope.prodetail.getImage()}">
                                            <img src="images/${sessionScope.prodetail.getImage()}" alt="First slide" style="margin-left: 370px;border-radius: 15px;">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="short_overview my-5">
                                                <p> Màu:  ${sessionScope.prodetail.getColor()}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="short_overview my-5">
                                                <p>Chất liệu:  ${sessionScope.prodetail.getMaterial()}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="short_overview my-5">
                                                <p> Kích thước:  ${sessionScope.prodetail.getSize()}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="short_overview my-5">
                                                <p> Nhà sản xuất:  ${sessionScope.prodetail.getManufacturer()}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
