                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <a class="gallery_img" href="${sessionScope.prodetail.getImg()}">
                                                <img class="d-block w-100" src="${sessionScope.prodetail.getImg()}" alt="First slide" style="border-radius: 15px;">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="single_product_desc">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <!-- Avaiable -->
                                    <p class="avaibility"><i class="fa fa-circle"></i> ${sessionScope.prodetail.getQuantity()}</p>
                                </div>
