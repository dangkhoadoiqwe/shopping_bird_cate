                       ...
                       <c:set var="id1" value="${prodetail[0]}" />
                        ...
                        <td>
                            <div class="comparison-item"> 
                                   <a href="MainController?action=compro&proid=${id2.getId()}">  <span class="remove-item" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span>
                               </a>
                                <a class="comparison-item-thumb" href="MainController?action=ProDetail&proid=${id1.getId()}"><img src=" ${id1.getImage()}" alt="Apple iPhone Xs Max"></a><a class="comparison-item-title" href="MainController?action=ProDetail&proid=${id1.getId()}" > ${id1.getName()}</a>
                        ...
                        <td>
                            <div class="comparison-item">  
                                  <a href="MainController?action=compro&proid=${id1.getId()}">  <span class="remove-item" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span>
                               </a>
                                <a class="comparison-item-thumb" href="MainController?action=ProDetail&proid=${id2.getId()}"><img src=" ${id2.getImage()}" alt="Apple iPhone Xs Max"></a><a class="comparison-item-title" href="MainController?action=ProDetail&proid=${id2.getId()}" > ${id2.getName()}</a>
                                 <form class="cart clearfix" method="get" action="addtocart">
                        ...
                        <div class="row" style="   background-color :#fff; ">
                            <c:forEach var="product" items="${product}">
                                <div class="col-12 col-md-4 col-lg-3 mb-5">
                                     <a class="product-item" href="MainController?action=com3&proid=${id1.getId()}&proid2=${id2.getId()}&proid3=${product.getId()}">
