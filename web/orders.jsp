        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a  class="logo"> <img src="admin-staff/assets/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">FURNI</span> </a>
                    <a  class="logo logo-small"> <img src="admin-staff/assets/img/hotel_logo.png" alt="Logo" width="30" height="30"> </a>
                </div>
                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="MainController?action=loadaccStaff&id=${sessionScope.account.getId()}">My Profile</a>   
                                            ...
                                            <c:forEach var="c" items="${orders}">
                                                <tr>
                                                    ...
                                                    <c:choose> 
                                                        ...
                                                        <c:when test="${c.getStatus() == 2}">
                                                            <td>    Thanh toán tiền măt </td>
                                                        </c:when>
                                                        <c:when test="${c.getStatus() == 3}">
                                                            <td>    đã thanh toán  </td>
                                                        </c:when>
                                                    </c:choose>
                                                        ...
                                                        <div class="actions">
                                                            <form id="statusForm" action="updateStatus" method="post">
                                                                <c:choose>
                                                                    ...
                                                                    <c:when test="${c.getDelivery().getStatus() == 7}">
                                                                        <a  class="btn btn-sm bg-success-light mr-2" value="3" selected>Hoàn thành</a>
                                                                    </c:when>
                                                                </c:choose>
