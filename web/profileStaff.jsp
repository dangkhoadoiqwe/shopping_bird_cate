    ...
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left">
                <a href="MainController?action=loadaccStaff&id=${sessionScope.account.getId()}" class="logo"> <img src="assets/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">HOTEL</span> </a>
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        ...
                        </div> <a class="dropdown-item" href="profile.jsp">My Profile</a>    <a class="dropdown-item" href="MainController?action=logout">Logout</a></div>
                </li>
            </ul>
        </div>
                                            ...
                                            <form action="updateacc" method="post">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="hidden" class="form-control" value="${sessionScope.account.getId()}" id="id" name="id">
                                                        <input type="text" class="form-control" value="${sessionScope.account.getName()}" id="fullName" name="name">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="hidden" class="form-control" value="${sessionScope.account.getProfilePhoto()}" id="profilePhoto" name="profilePhoto">
                                                        <input type="text" class="form-control" value="${sessionScope.account.getEmail()}" id="email" name="email">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" class="form-control" value="${sessionScope.account.getPhone()}" id="phone" name="phone">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-9 text-secondary">
                                                        <input type="text" class="form-control" value="${sessionScope.account.getAddress()}" name="address" id="address">
                                                    </div>
                                                </div>
...
<!--                                                    <a class="edit-link" data-toggle="modal" href="#edit_personal"><i class="fa fa-edit mr-1"></i>Thay đổi</a>-->
                                                ...
                                                <img class="avatar-img rounded-circle" alt="User Image" src="${sessionScope.account.getProfilePhoto()}">
                                                <!--                                                    <div class="row mt-5">
                                            ...
                                            <div class="col-md-10 col-lg-6">
                                                <form action="UpdatePasswordController" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="new-pass" class="form-control"> </div>
                                                    <div class="form-group">
                                                        <label>Nhập lại mật khẩu</label>
                                                        <input type="password" name="renew-pass" class="form-control"> </div>
                                                    <c:if test="${not empty requestScope.errorMessage}">
                                                        <div class="error-message">${requestScope.errorMessage1}</div>
                                                    </c:if>
