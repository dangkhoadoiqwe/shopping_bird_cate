...
public class AccountDao {
    ...
    private static final String REGISTER = "INSERT INTO Account(email, password, name, role, phone, accountStatus, Address,profilePhoto)VALUES(?, ?, ?, ?, ?, 1, ?,?)";
    ...
    public boolean insertAccount(Account acc) throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                ...
                stm.setString(7, "images/" + acc.getProfilePhoto());
    ...
    private static final String UPDATE_ACCOUNT = "UPDATE Account SET name= ? , email = ? ,password = ?, phone = ?,Address=?,role =? , profilePhoto=? WHERE accountID = ? ";
    ...
    public boolean updateAccount(Account account) throws SQLException {
        ...
        try {
            ...
            if (con != null) {
                ...
                stm.setString(7, account.getProfilePhoto());
    ...
    private static final String FIND_ACCOUNT_BY_Staff = "SELECT * FROM Account WHERE role = 3";
            ...
            if (con != null) {
                ...
                if (rs != null) {
                    while (rs.next()) {
                        ...
                        acc.setProfilePhoto(rs.getString("profilePhoto"));
