...
public class Loaddeliverydetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int paymentID = Integer.parseInt(request.getParameter("cartID"));
            int deli = Integer.parseInt(request.getParameter("payID"));
            FeedbackDao feedbackDao = new FeedbackDao();
            List<Feedback> products = feedbackDao.getfeedByPaymentID(paymentID);
