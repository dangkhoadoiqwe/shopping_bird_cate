 ...
 * @author Admin
 */
@WebServlet(name = "addcompare2", urlPatterns = {"/addcompare2"})
public class addcompare2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                List<Product> d = a.get2id(pro1, pro2);
                List<Product> c = a.getnot2id(pro2, pro1);
                if (d != null) {
