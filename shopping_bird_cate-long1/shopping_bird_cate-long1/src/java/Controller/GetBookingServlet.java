...
public class GetBookingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (br != null) {
            ...
            json.addProperty("color", br.getColor());
            System.out.println(br.getColor());
            json.addProperty("materialCustomName", new String(br.getMaterialCustom().getBytes("iso-8859-1"), "utf-8"));
            json.addProperty("size", new String(br.getSize().getBytes("iso-8859-1"), "utf-8"));
