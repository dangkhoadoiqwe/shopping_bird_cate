<%-- 
    ...
    Created on : 30-09-2023, 16:23:33
    Author     : Quang
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="admin-staff/admin-staff/assets/img/favicon.png">
        <link rel="stylesheet" href="admin-staff/admin-staff/assets/css/bootstrap.min.css">
        <link rel="stylesheet" href="admin-staff/admin-staff/assets/plugins/fontawesome/css/fontawesome.min.css">
        ...
        <link rel="stylesheet" type="text/css" href="admin-staff/assets/css/bootstrap-datetimepicker.min.css">
        <link rel="stylesheet" href="admin-staff/assets/css/style.css"> </head>

    <body>
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a href="index.html" class="logo"> <img src="admin-staff/assets/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">HOTEL</span> </a>
                            ...
                            <div class="noti-content">
                                <ul class="notification-list">
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image" src="admin-staff/assets/img/profiles/avatar-02.jpg">
                                                </span>
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image" src="admin-staff/assets/img/profiles/avatar-11.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image" src="admin-staff/assets/img/profiles/avatar-17.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media"> <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="User Image" src="admin-staff/assets/img/profiles/avatar-13.jpg">
                                                </span>
                                                <div class="media-body">
                        ...
                        <ul>
                            ...
                            <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Booking </span> <span class="menu-arrow"></span></a>
                                <ul class="submenu_class" style="display: none;">
                                    ...
                                    <li><a href="allBoking.jsp"> Edit Booking </a></li>
...
<!--                                    <li><a href="edit-customer.html"> Edit Customer </a></li>
                            ...
                            <li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Staff </span> <span class="menu-arrow"></span></a>
                                <ul class="submenu_class" style="display: none;">
                                    ...
                                    <li><a class="active" href="addstaff.jsp"> Add Staff </a></li>
                                </ul>
                            </li>
                            <!--						<li> <a href="pricing.html"><i class="far fa-money-bill-alt"></i> <span>Pricing</span></a> </li>
                                                                            ...
                                                                            <li> <a href="admin-staff/assets.html"><i class="fas fa-cube"></i> <span>Assests</span></a> </li>
...
<!--                                                <option>Room Cleaners</option>
                    ...
                    <button type="button" class="btn btn-primary buttonedit ml-2">Thêm nhân viên</button>
                </div>
            </div>
        </div>
        ...
        <script src="admin-staff/assets/plugins/raphael/raphael.min.js"></script>
