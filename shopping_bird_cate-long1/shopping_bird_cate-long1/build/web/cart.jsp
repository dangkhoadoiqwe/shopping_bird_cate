                    ...
                    <div class="col-md-6">
                        <div class="row mb-5">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <button class="btn btn-black btn-sm btn-block"  href="removeallfromcart"> Remove all </button>
                            </div>
                            <div class="col-md-6" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <c:choose>
                                                <c:when test="${sessionScope.account.role == 1}">
                                                    <button class="btn btn-black btn-lg py-3 btn-block" type="button" onclick="window.location.href = 'checkout'">Check Out</button>
                                                </c:when>
                                                <c:otherwise>
