<%-- 
    ...
    Created on : Oct 1, 2023, 10:41:15 PM
    Author     : hailo
--%>
        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
                    <a href="index.html" class="logo"> <img src="assets/img/hotel_logo.png" width="50" height="70" alt="logo"> <span class="logoclass">FUNIR</span> </a>
            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            <li class="active"> <a href="homeManager.jsp"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a> </li>
                            <li class="list-divider"></li>
                            <li class="active"> <a href="MainController?action=ALLBOOKING"><i class="fas fa-suitcase"></i> <span>Bookings</span></a> </li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="dash-widget-header">
                                        <div>
                                            ...
                                            <h6 class="text-muted">Tổng đơn đặt hàng theo yêu cầu</h6> </div>
                                ...
                                <div class="card-body">
                                    <div class="dash-widget-header">
                                        <div>
                                            ...
                                            <h6 class="text-muted">Số lồng đã bán</h6> </div>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="card board1 fill">
                                <div class="card-body">
                                    <div class="dash-widget-header">
                                        <div>
                                            <h3 class="card_widget_header">1 jack</h3>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="card card-chart">
                                <div class="card-header">
                                    <h4 class="card-title">Thống kê khách hàng</h4> </div>
                                <div class="card-body">
