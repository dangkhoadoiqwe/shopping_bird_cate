                                                    ...
                                                    <td>
                                                        <div class="actions">
                                                            <form id="statusForm" action="updateStatus" method="post">
                                                                ...
                                                                <input type="hidden" name="cartID" value="${c.getOrder().getId()}">
                                                                <c:choose>
                                                            ...
                                                            <form action="Cancelpayment" method="post">
                                                                <div class="modal-body text-center">
                                                                    ...
                                                                    <div class="m-t-20">
                                                                        ...
                                                                        <button type="submit" class="btn btn-danger" id="confirmCancel_${c.getId()}">Hủy</button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
