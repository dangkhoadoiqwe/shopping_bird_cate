<%-- 
    ...
    Created on : 30-09-2023, 18:51:34
    Author     : Quang
--%>
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="index.html" class="logo">
                        ...
                        <span class="logoclass">FURNI</span>
                    </a>
            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            <li>
                                <a href="homeManager.jsp"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a>
                            </li>
                            ...
                            <li class="submenu">
                                ...
                                <ul class="submenu_class" style="display: none;">
                                    ...
                                    <li><a class="active" href="editBooking.jsp"> Edit Booking </a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
